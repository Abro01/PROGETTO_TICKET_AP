...
{
    public partial class FormInterfacciaCEO : Form
    {
        ...
        {
            OpenChildForm(new Forms.CEO.FormHomeCEO(), sender);
        }
        ...
        {
            OpenChildForm(new Forms.CEO.FormProfiloCEO(), sender);
        }

        private void btnImpostazioni_Click(object sender, EventArgs e)
        {
            OpenChildForm(new Forms.CEO.FormImpostazioniCEO(), sender);
        }
        ...
        private void FormInterfacciaCEO_Load(object sender, EventArgs e)
        {
            con.cn.Open();
        }
    }
